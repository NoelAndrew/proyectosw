...
function getProd($user,$pass,$categoria) {
    ...
    $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/999.json';
    ...
    if($usuario == null)
    {
        $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/500.json';
        ...
        if($usuario == md5($pass)){
            $url = 'https://alumnosws-default-rtdb.firebaseio.com/productos/'.$categoria.'.json';
            $ch = curl_init();
            curl_setopt($ch,CURLOPT_URL,$url);
            curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
            $cat = curl_exec($ch);
            ...
            $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/200.json';
            ...
            if ( $cat != null ) {
               $resp = array( 
                ...
                $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/300.json';
            ...
            $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/501.json';
...
function getDetails($user,$pass,$isbn) {
    ...
    if($usuario == null)
    {
        ...
        if($usuario == md5($pass)){
            ...
            $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/201.json';
            ...
            if ( $ISBN != null ) {
                ...
                //error_log($categoria);
                $url = 'https://alumnosws-default-rtdb.firebaseio.com/respuestas/301.json';
